...
class ProductSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Product::query()->updateOrCreate(['name' => 'Pink Floyd - Dark Side of the Moon'], ['type_id' => $typeIds['LP'], 'grade_id' => $gradeIds['B'], 'is_digital_id' => $digitalIds['Nej'], 'release' => '1997-01-01', 'desc' => 'Re-release af Dark Side of the Moon (1973), genudgivet i 1997. Originale plakater medfølger.', 'stock' => 1, 'img_url' => '/images/products/pink-floyd-dark-side-of-the-moon.jpg', 'price' => 3000]);
        Product::query()->updateOrCreate(['name' => 'Battlefield 1'], ['type_id' => $typeIds['Film'], 'grade_id' => $gradeIds['S'], 'is_digital_id' => $digitalIds['Nej'], 'release' => '2016-01-01', 'desc' => 'Battlefield 1 i uåbnet tilstand, købt i 2016.', 'stock' => 1, 'img_url' => '/images/products/battlefield-1.jpg', 'price' => 100]);
    }
}
